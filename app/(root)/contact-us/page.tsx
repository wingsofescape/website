...
const ContactUs = () => {
  return (
    <div className="flex flex-col justify-between items-center mx-auto w-full flex-wrap p-5 md:pb-10  text-theme-primary-dark">
      ...
      <h2 className="text-xl font-bold mt-15 mb-5">
        {" "}
        Quick Support
      </h2>
      <div className="card-container flex flex-col md:flex-row gap-4 md:gap-8 w-full md:w-2/3 p-8">
        <div className="card rounded-2xl w-full shadow-xl p-6 md:h-50 md:w-1/3 flex flex-row-reverse md:flex-col justify-between relative">
          <div className="iconContainer">
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-telephone text-theme-primary-dark h-10 w-10"
              viewBox="0 0 16 16"
            >
        ...
        <Link href="https://wa.me/7700984599" target="_blank" rel="noopener noreferrer" className="w-full md:w-1/3">
          <div className="card rounded-2xl w-full shadow-xl p-6 md:h-50 flex flex-row-reverse md:flex-col justify-between">
            <div className="iconContainer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
                fill="currentColor"
                className="bi bi-whatsapp text-theme-primary-dark h-10 w-10"
                viewBox="0 0 16 16"
              >
        ...
        <div className="card rounded-2xl w-full shadow-xl p-6 md:h-50 md:w-1/3 flex flex-row-reverse md:flex-col justify-between">
          <div className="iconContainer">
            <svg
              ...
              height="16"
              fill="currentColor"
              className="bi bi-envelope-at text-theme-primary-dark h-10 w-10"
              viewBox="0 0 16 16"
            >
