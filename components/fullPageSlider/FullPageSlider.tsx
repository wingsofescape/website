        ...
        <div>
            <div className="relative inset-0 bg-theme-primary flex items-center justify-center z-10 overflow-hidden">
                <button
                    ...
                    className="absolute left-0 md:left-8 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center rounded-full justify-center hover:border-2 hover:border-slate-200 hover:scale-105 transition-transform duration-800 z-50 cursor-pointer"
                    aria-label="Previous"
                ...
                <div className="relative w-full h-full flex items-center justify-center">
                    <div className="relative w-full max-w-6xl h-[50vh] md:h-[90vh]">
                        {/* Current slide */}
                        <div
                        ...
                        >
                            <div className="w-2/5 md:w-1/2 p-6 md:p-10 flex flex-col justify-center h-full">
                                <h2 className="text-sm md:text-3xl font-bold text-white mb-4">{current.guestName}</h2>
                            ...
                            <div className="w-3/5 md:w-1/2 h-4/5 flex items-center justify-center bg-theme-primary-light relative">
                        ...
                        {isAnimating && incoming && (
                            ...
                            >
                                <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col justify-center h-full">
                                    <h2 className="text-sm md:text-3xl font-bold text-white mb-4">{incoming.guestName}</h2>
                                ...
                                <div className="w-full md:w-1/2 h-4/5 flex items-center justify-center bg-theme-primary-light relative">
                ...
                <button
                    ...
                    className="absolute right-0 md:right-8 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full flex items-center justify-center hover:border-2 hover:border-slate-200 hover:scale-105 transition-transform duration-800 z-50 cursor-pointer"
                    aria-label="Next"
                    disabled={isAnimating}
                >
                    <svg className="w-6 h-6 text-slate-700" fill="none" stroke="white" viewBox="0 0 24 24">
